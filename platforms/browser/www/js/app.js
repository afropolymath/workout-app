...
var author$project$AppTypes$SaveWorkout = function (a) {
	return {$: 'SaveWorkout', a: a};
};
var author$project$AppTypes$UpdateCurrentWorkout = F2(
	function (a, b) {
		return {$: 'UpdateCurrentWorkout', a: a, b: b};
	});
var author$project$AppTypes$UpdateCurrentWorkoutName = {$: 'UpdateCurrentWorkoutName'};
...
var author$project$SharedStyles$theme = {
	...
	applicationGutter: rtfeldman$elm_css$Css$px(20),
	applicationShadows: A5(
	...
	containerWidth: rtfeldman$elm_css$Css$px(1024),
	darkBorderColor: rtfeldman$elm_css$Css$hex('464646'),
	headerBackground: rtfeldman$elm_css$Css$hex('2F2F2F'),
	headerHeight: rtfeldman$elm_css$Css$px(60),
	lightBackground: rtfeldman$elm_css$Css$hex('EBEBEB'),
	lightBorderColor: rtfeldman$elm_css$Css$hex('848484'),
	lighterBorderColor: rtfeldman$elm_css$Css$hex('D2D2D2'),
	looseCardContentPadding: rtfeldman$elm_css$Css$px(15),
	secondaryColor: rtfeldman$elm_css$Css$hex('FF4800'),
	secondaryColorHover: rtfeldman$elm_css$Css$hex('E14001')
};
...
var author$project$ScreenCreateWorkout$cardFooterStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.cardFooterBackground),
...
var author$project$SharedStyles$fullWidthInputFieldStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var author$project$ScreenCreateWorkout$fullWidthCardInputFieldStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			author$project$SharedStyles$fullWidthInputFieldStyle,
			A2(
			...
			rtfeldman$elm_css$Css$px(1),
			rtfeldman$elm_css$Css$solid,
			author$project$SharedStyles$theme.lighterBorderColor),
			rtfeldman$elm_css$Css$focus(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$outline(rtfeldman$elm_css$Css$none),
					rtfeldman$elm_css$Css$borderColor(author$project$SharedStyles$theme.secondaryColor)
				]))
		]));
var author$project$AppTypes$UpdateCurrentWorkoutExercise = F2(
	function (a, b) {
		return {$: 'UpdateCurrentWorkoutExercise', a: a, b: b};
	});
var author$project$ScreenCreateWorkout$exerciseTableFieldInputStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			author$project$SharedStyles$fullWidthInputFieldStyle,
			A2(
...
var author$project$ScreenCreateWorkout$exerciseTableFieldStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A3(
			rtfeldman$elm_css$Css$borderBottom3,
...
var author$project$ScreenCreateWorkout$renderExerciseItemRow = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[author$project$ScreenCreateWorkout$exerciseTableFieldStyle]))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[author$project$ScreenCreateWorkout$exerciseTableFieldInputStyle])),
									rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
									rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Enter exercise name'),
									rtfeldman$elm_css$Html$Styled$Attributes$value(exercise.name),
									rtfeldman$elm_css$Html$Styled$Events$onInput(
									author$project$AppTypes$UpdateCurrentWorkout(
										A2(author$project$AppTypes$UpdateCurrentWorkoutExercise, exerciseIndex, 'name')))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Html$Styled$Attributes$placeholder('0'),
									rtfeldman$elm_css$Html$Styled$Attributes$value(
									elm$core$String$fromInt(exercise.sets)),
									rtfeldman$elm_css$Html$Styled$Events$onInput(
									author$project$AppTypes$UpdateCurrentWorkout(
										A2(author$project$AppTypes$UpdateCurrentWorkoutExercise, exerciseIndex, 'sets')))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Html$Styled$Attributes$placeholder('0'),
									rtfeldman$elm_css$Html$Styled$Attributes$value(
									elm$core$String$fromInt(exercise.reps)),
									rtfeldman$elm_css$Html$Styled$Events$onInput(
									author$project$AppTypes$UpdateCurrentWorkout(
										A2(author$project$AppTypes$UpdateCurrentWorkoutExercise, exerciseIndex, 'reps')))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									rtfeldman$elm_css$Html$Styled$Attributes$placeholder('0'),
									rtfeldman$elm_css$Html$Styled$Attributes$value(
									elm$core$String$fromInt(exercise.weight)),
									rtfeldman$elm_css$Html$Styled$Events$onInput(
									author$project$AppTypes$UpdateCurrentWorkout(
										A2(author$project$AppTypes$UpdateCurrentWorkoutExercise, exerciseIndex, 'weight')))
								]),
							_List_Nil)
						]))
				]));
...
var author$project$SharedStyles$applicationModuleStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute),
			rtfeldman$elm_css$Css$top(author$project$SharedStyles$theme.headerHeight),
			rtfeldman$elm_css$Css$bottom(
			rtfeldman$elm_css$Css$px(0)),
			rtfeldman$elm_css$Css$left(
			rtfeldman$elm_css$Css$px(0)),
...
var author$project$SharedStyles$cardContainerStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.lightBackground),
...
var author$project$SharedStyles$defaultButtonStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$hex('FFFF')),
			A2(
			rtfeldman$elm_css$Css$padding2,
			rtfeldman$elm_css$Css$px(7),
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.secondaryColorHover)
				])),
			rtfeldman$elm_css$Css$focus(
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$Transitions$backgroundColor(1000)
				]))
		]));
...
var author$project$SharedStyles$genericContainerStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$pct(100)),
			rtfeldman$elm_css$Css$maxWidth(author$project$SharedStyles$theme.containerWidth),
			A2(
...
var author$project$SharedStyles$tableHeaderStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2(
			rtfeldman$elm_css$Css$padding2,
...
var author$project$ScreenCreateWorkout$renderWorkoutCreationForm = function (workoutRec) {
	return A2(
		...
		_List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[author$project$SharedStyles$applicationModuleStyle]))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[author$project$SharedStyles$genericContainerStyle, author$project$SharedStyles$cardContainerStyle]))
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[author$project$ScreenCreateWorkout$fullWidthCardInputFieldStyle])),
										rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
										rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Workout name...'),
										rtfeldman$elm_css$Html$Styled$Events$onInput(
										author$project$AppTypes$UpdateCurrentWorkout(author$project$AppTypes$UpdateCurrentWorkoutName))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[author$project$ScreenCreateWorkout$cardTableContainerStyle]))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		author$project$SharedStyles$tableHeaderStyle,
																		rtfeldman$elm_css$Css$width(
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$text('Exercise name')
															])),
														A2(
														rtfeldman$elm_css$Html$Styled$th,
														_List_fromArray(
														...
														_List_fromArray(
															[
																rtfeldman$elm_css$Html$Styled$text('Reps')
															])),
														A2(
														rtfeldman$elm_css$Html$Styled$th,
														_List_fromArray(
										...
										_List_Nil,
										A2(elm$core$List$indexedMap, author$project$ScreenCreateWorkout$renderExerciseItemRow, workoutRec.exercises))
									]))
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[author$project$ScreenCreateWorkout$cardFooterStyle]))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[author$project$SharedStyles$defaultButtonStyle])),
										rtfeldman$elm_css$Html$Styled$Events$onClick(
										author$project$AppTypes$SaveWorkout(workoutRec))
									]),
								_List_fromArray(
									[
										rtfeldman$elm_css$Html$Styled$text('Save workout')
									]))
							]))
					]))
			]));
};
var author$project$ScreenMain$fullScreenContainerMixin = _List_fromArray(
	[
		rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute),
...
var author$project$ScreenMain$applicationContainerStyle = rtfeldman$elm_css$Css$batch(
	_Utils_ap(
		_List_fromArray(
			[
				rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.applicationBackground),
				rtfeldman$elm_css$Css$height(
				rtfeldman$elm_css$Css$pct(100))
			]),
		author$project$ScreenMain$fullScreenContainerMixin));
var author$project$AppTypes$CreateWorkout = {$: 'CreateWorkout'};
var author$project$ScreenMain$headerStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.headerBackground),
			rtfeldman$elm_css$Css$height(author$project$SharedStyles$theme.headerHeight),
			A2(
			rtfeldman$elm_css$Css$padding2,
			rtfeldman$elm_css$Css$px(0),
			author$project$SharedStyles$theme.applicationGutter)
		]));
...
var author$project$ScreenMain$headerTextStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$color(
			...
			rtfeldman$elm_css$Css$px(0)),
			rtfeldman$elm_css$Css$lineHeight(author$project$SharedStyles$theme.headerHeight)
		]));
...
var author$project$SharedStyles$flexContainer = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var author$project$ScreenMain$renderApplicationHeader = A2(
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[author$project$ScreenMain$headerStyle]))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$SharedStyles$genericContainerStyle, author$project$SharedStyles$flexContainer]))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[author$project$ScreenMain$headerTextStyle]))
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Workout Zeug')
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$button,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[author$project$SharedStyles$defaultButtonStyle])),
							rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$AppTypes$CreateWorkout)
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text('Create workout')
						]))
				]))
		]));
...
var author$project$ScreenSingleWorkout$tableFieldStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[author$project$ScreenSingleWorkout$tableFieldStyle]))
						]),
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$text(exercise.name)
			...
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[author$project$SharedStyles$genericContainerStyle, author$project$SharedStyles$cardContainerStyle, author$project$SharedStyles$secondaryCardContainerStyle]))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[author$project$ScreenSingleWorkout$workoutDetailsStyle]))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										rtfeldman$elm_css$Html$Styled$tbody,
										_List_Nil,
										A2(elm$core$List$indexedMap, author$project$ScreenSingleWorkout$renderExerciseItemRow, workoutRec.exercises))
									]))
							]))
					]))
			]));
};
var author$project$AppTypes$DisplayOne = function (a) {
	return {$: 'DisplayOne', a: a};
};
var author$project$AppTypes$ToggleWorkoutListItem = function (a) {
	return {$: 'ToggleWorkoutListItem', a: a};
};
...
var author$project$ScreenWorkoutListing$workoutListItemMetricsTableHeader = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
...
var author$project$ScreenWorkoutListing$renderMetric = F2(
	function (metricName, metricValue) {
		return _List_fromArray(
			[
				A2(
				rtfeldman$elm_css$Html$Styled$th,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[author$project$ScreenWorkoutListing$workoutListItemMetricsTableHeader]))
					]),
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(metricName)
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$td,
				_List_Nil,
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(metricValue)
					]))
			]);
	});
var rtfeldman$elm_css$Css$marginBottom = rtfeldman$elm_css$Css$prop1('margin-bottom');
var author$project$ScreenWorkoutListing$workoutListItem = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$backgroundColor(author$project$SharedStyles$theme.cardBackgroundColor),
			A2(
			rtfeldman$elm_css$Css$padding2,
			rtfeldman$elm_css$Css$px(0),
			...
			rtfeldman$elm_css$Css$px(1),
			rtfeldman$elm_css$Css$solid,
			author$project$SharedStyles$theme.lightBorderColor),
			rtfeldman$elm_css$Css$marginBottom(
			rtfeldman$elm_css$Css$px(17)),
			rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$borderColor(author$project$SharedStyles$theme.cardHoverBorderColor),
					author$project$SharedStyles$theme.applicationShadows
				]))
		]));
var author$project$ScreenWorkoutListing$workoutListItemHeader = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$height(
			...
			rtfeldman$elm_css$Css$px(1),
			rtfeldman$elm_css$Css$solid,
			author$project$SharedStyles$theme.darkBorderColor),
			rtfeldman$elm_css$Css$cursor(rtfeldman$elm_css$Css$pointer)
		]));
var author$project$ScreenWorkoutListing$workoutListItemLink = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$color(author$project$SharedStyles$theme.secondaryColor),
			rtfeldman$elm_css$Css$fontSize(
...
var author$project$ScreenWorkoutListing$workoutListItemMetricsTable = function (isOpen) {
	return rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$px(0)),
				author$project$SharedStyles$theme.applicationFont,
				rtfeldman$elm_css$Css$color(author$project$SharedStyles$theme.cardTextColor),
				isOpen ? rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$table) : rtfeldman$elm_css$Css$display(rtfeldman$elm_css$Css$none)
			]));
};
...
var author$project$ScreenWorkoutListing$workoutListItemTitle = function (isOpen) {
	return rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$relative),
				...
				_List_fromArray(
					[
						...
						rtfeldman$elm_css$Css$left(
						rtfeldman$elm_css$Css$px(8)),
						isOpen ? rtfeldman$elm_css$Css$top(
						rtfeldman$elm_css$Css$px(-5)) : rtfeldman$elm_css$Css$top(
						...
						rtfeldman$elm_css$Css$rotate(
							rtfeldman$elm_css$Css$deg(45))) : rtfeldman$elm_css$Css$transform(
						rtfeldman$elm_css$Css$rotate(
							rtfeldman$elm_css$Css$deg(225)))
					]))
			]));
};
	...
	function (workoutItemIndex, workoutRec) {
		var totalReps = A3(
			...
			A2(
				elm$core$List$map,
				function (ex) {
					return ex.reps * ex.sets;
				},
				workoutRec.exercises));
		var totalExercises = elm$core$List$length(workoutRec.exercises);
		return A2(
			rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$ScreenWorkoutListing$workoutListItem]))
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[author$project$ScreenWorkoutListing$workoutListItemLink])),
									rtfeldman$elm_css$Html$Styled$Events$onClick(
									author$project$AppTypes$DisplayOne(workoutRec))
								]),
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('View workout')
								]))
						])),
					A2(
					rtfeldman$elm_css$Html$Styled$table,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$ScreenWorkoutListing$workoutListItemMetricsTable(workoutRec.isOpen)
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										A2(
											author$project$ScreenWorkoutListing$renderMetric,
											'Exercises',
											elm$core$String$fromInt(totalExercises)),
										A2(author$project$ScreenWorkoutListing$renderMetric, 'Times completed', 'Metric 2 value'))),
									A2(
									rtfeldman$elm_css$Html$Styled$tr,
									_List_Nil,
									_Utils_ap(
										A2(
											author$project$ScreenWorkoutListing$renderMetric,
											'Total Reps',
											elm$core$String$fromInt(totalReps)),
										A2(author$project$ScreenWorkoutListing$renderMetric, 'Success rate', 'Metric 2 value'))),
									A2(
									rtfeldman$elm_css$Html$Styled$tr,
									_List_Nil,
									A2(author$project$ScreenWorkoutListing$renderMetric, 'Estimated time', '-'))
								]))
						]))
				]));
	});
...
var author$project$ScreenWorkoutListing$renderWorkoutList = function (workoutList) {
	var displayContent = (elm$core$List$length(workoutList) > 0) ? elm$core$List$reverse(
		...
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('There are no workouts here yet')
				]))
		]);
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
			...
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[author$project$SharedStyles$genericContainerStyle]))
					]),
				displayContent)
			]));
};
...
var author$project$ScreenMain$view = function (model) {
		...
		A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$ScreenMain$applicationContainerStyle]))
				]),
			_List_fromArray(
				[
					author$project$ScreenMain$renderApplicationHeader,
					function () {
					var _n0 = model.currentWorkout;
					switch (_n0.$) {
						case 'CreatedWorkout':
							var workoutRec = _n0.a;
							return author$project$ScreenSingleWorkout$renderSingleWorkout(workoutRec);
						case 'NewWorkout':
							var workoutRec = _n0.a;
							return author$project$ScreenCreateWorkout$renderWorkoutCreationForm(workoutRec);
						default:
							return author$project$ScreenWorkoutListing$renderWorkoutList(model.workouts);
					}
				}()
				])));
};
var author$project$AppTypes$Model = F2(
	function (workouts, currentWorkout) {
		return {currentWorkout: currentWorkout, workouts: workouts};
	});
var author$project$AppTypes$NoWorkoutSelected = {$: 'NoWorkoutSelected'};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$State$init = function (flags) {
	var workouts = function () {
		if (flags.$ === 'Just') {
			var cachedWorkouts = flags.a;
	...
	return _Utils_Tuple2(
		A2(author$project$AppTypes$Model, workouts, author$project$AppTypes$NoWorkoutSelected),
...
var author$project$Ports$cacheWorkouts = _Platform_outgoingPort(
	'cacheWorkouts',
								...
								return elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'isEmpty',
											elm$json$Json$Encode$bool($.isEmpty)),
											_Utils_Tuple2(
											'isPristine',
											elm$json$Json$Encode$bool($.isPristine)),
											_Utils_Tuple2(
											'name',
											elm$json$Json$Encode$string($.name)),
											_Utils_Tuple2(
											'ref',
											elm$json$Json$Encode$string($.ref)),
											_Utils_Tuple2(
											'reps',
											elm$json$Json$Encode$int($.reps)),
											_Utils_Tuple2(
											'sets',
											elm$json$Json$Encode$int($.sets)),
											_Utils_Tuple2(
											'weight',
											elm$json$Json$Encode$int($.weight)),
											_Utils_Tuple2(
											'weightUnit',
											elm$json$Json$Encode$string($.weightUnit))
										]));
							})($.exercises)),
						_Utils_Tuple2(
						'isOpen',
...
var author$project$AppTypes$CreatedWorkout = function (a) {
	return {$: 'CreatedWorkout', a: a};
};
var author$project$State$addWorkout = F2(
	function (workoutRec, workoutsList) {
		return _Utils_ap(
			workoutsList,
			_List_fromArray(
				[workoutRec]));
	});
var author$project$AppTypes$NewWorkout = function (a) {
	return {$: 'NewWorkout', a: a};
};
var author$project$AppTypes$WorkoutRec = F3(
	function (name, exercises, isOpen) {
		return {exercises: exercises, isOpen: isOpen, name: name};
	});
var author$project$AppTypes$Exercise = F8(
	function (name, ref, sets, reps, weight, weightUnit, isEmpty, isPristine) {
		return {isEmpty: isEmpty, isPristine: isPristine, name: name, ref: ref, reps: reps, sets: sets, weight: weight, weightUnit: weightUnit};
	});
var author$project$State$emptyExercise = A8(author$project$AppTypes$Exercise, '', '', 0, 0, 0, 'kg', true, true);
var author$project$State$emptyWorkout = author$project$AppTypes$NewWorkout(
	A3(
		author$project$AppTypes$WorkoutRec,
		'',
		_List_fromArray(
			[author$project$State$emptyExercise]),
		false));
var author$project$State$toggleWorkout = F2(
	function (workoutIndex, workoutList) {
		var toggleItem = F2(
			function (index, item) {
				return _Utils_eq(index, workoutIndex) ? _Utils_update(
					item,
					{isOpen: !item.isOpen}) : item;
			});
		return A2(elm$core$List$indexedMap, toggleItem, workoutList);
	});
var elm$core$String$toInt = _String_toInt;
var author$project$State$updateWorkout = F3(
	function (currentWorkout, updateAction, fieldValue) {
		var updateExerciseAtIndex = F4(
			function (exerciseIndex, fieldName, index, exercise) {
							...
							return _Utils_update(
								exercise,
								{
									sets: A2(
										elm$core$Maybe$withDefault,
										0,
										elm$core$String$toInt(fieldValue))
								});
						case 'reps':
							return _Utils_update(
								exercise,
				...
				var rowIsEmpty = (updatedFields.name === '') && ((!updatedFields.reps) && ((!updatedFields.sets) && (!updatedFields.weight)));
				return _Utils_eq(index, exerciseIndex) ? _Utils_update(
					updatedFields,
					{isEmpty: rowIsEmpty, isPristine: false}) : exercise;
			});
		var filterEmpty = function (exercises) {
			var nonEmptyExercises = A2(
				elm$core$List$filter,
				function (ex) {
					return !ex.isEmpty;
				},
			...
			var filteredList = A2(
				elm$core$List$filter,
				function (ex) {
					return (!ex.isEmpty) || ex.isPristine;
				},
				exercises);
			var _n2 = elm$core$List$length(exercises) - elm$core$List$length(nonEmptyExercises);
			switch (_n2) {
				case 0:
					return _Utils_ap(
						exercises,
		...
		var updateWorkoutField = function (workoutRec) {
			if (updateAction.$ === 'UpdateCurrentWorkoutName') {
				return _Utils_update(
					workoutRec,
					{name: fieldValue});
			} else {
				var exerciseIndex = updateAction.a;
				var fieldName = updateAction.b;
				return _Utils_update(
					workoutRec,
					{
						exercises: filterEmpty(
							A2(
								elm$core$List$indexedMap,
								A2(updateExerciseAtIndex, exerciseIndex, fieldName),
								workoutRec.exercises))
					});
			}
		};
		switch (currentWorkout.$) {
			case 'CreatedWorkout':
				var workoutRec = currentWorkout.a;
				return author$project$AppTypes$CreatedWorkout(
					updateWorkoutField(workoutRec));
			case 'NewWorkout':
				var workoutRec = currentWorkout.a;
				return author$project$AppTypes$NewWorkout(
					updateWorkoutField(workoutRec));
			default:
				return author$project$AppTypes$NoWorkoutSelected;
		}
	});
		...
		switch (msg.$) {
			case 'DisplayAll':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentWorkout: author$project$AppTypes$NoWorkoutSelected}),
					elm$core$Platform$Cmd$none);
			case 'DisplayOne':
				var workoutRec = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentWorkout: author$project$AppTypes$CreatedWorkout(workoutRec)
						}),
					elm$core$Platform$Cmd$none);
			case 'CreateWorkout':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentWorkout: author$project$State$emptyWorkout}),
					elm$core$Platform$Cmd$none);
			case 'UpdateCurrentWorkout':
				var updateAction = msg.a;
				var fieldValue = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentWorkout: A3(author$project$State$updateWorkout, model.currentWorkout, updateAction, fieldValue)
						}),
					elm$core$Platform$Cmd$none);
			case 'SaveWorkout':
				var workoutRec = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							currentWorkout: author$project$AppTypes$NoWorkoutSelected,
							workouts: A2(author$project$State$addWorkout, workoutRec, model.workouts)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var itemIndex = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							workouts: A2(author$project$State$toggleWorkout, itemIndex, model.workouts)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$State$updateWithStorage = F2(
	function (msg, model) {
		...
		var newModel = _n0.a;
		var commands = _n0.b;
		var workouts = newModel.workouts;
		return _Utils_Tuple2(
			newModel,
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						commands,
						author$project$Ports$cacheWorkouts(workouts)
					])));
	});
...
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$State$init, subscriptions: author$project$State$subscriptions, update: author$project$State$updateWithStorage, view: author$project$ScreenMain$view});
									...
									return A2(
										...
										function (exercises) {
											return elm$json$Json$Decode$succeed(
												{exercises: exercises, isOpen: isOpen, name: name});
										},
										A2(
																...
																return A2(
																	...
																	function (sets) {
																		return A2(
																								...
																								return A2(
																									...
																									function (isPristine) {
																										return A2(
																											...
																											function (isEmpty) {
																												return elm$json$Json$Decode$succeed(
																													{isEmpty: isEmpty, isPristine: isPristine, name: name, ref: ref, reps: reps, sets: sets, weight: weight, weightUnit: weightUnit});
																											},
																											A2(elm$json$Json$Decode$field, 'isEmpty', elm$json$Json$Decode$bool));
																									},
																			...
																			A2(elm$json$Json$Decode$field, 'reps', elm$json$Json$Decode$int));
																	},
																	A2(elm$json$Json$Decode$field, 'sets', elm$json$Json$Decode$int));
															},
															A2(elm$json$Json$Decode$field, 'weight', elm$json$Json$Decode$int));
													},
													A2(elm$json$Json$Decode$field, 'weightUnit', elm$json$Json$Decode$string)))));
								},
